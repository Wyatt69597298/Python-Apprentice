"""
The is a simple Crab program that draws a square and writes a message. The
...
tina.pencolor('purple')                  # Set the pencil color to green
tina.forward(150)
tina.left(90)


tina.pencolor('green')                 # Set the pencil color to purple
tina.forward(150)
tina.left(90)
...
tina.forward(20)                        # Move tina forward by 20
tina.write("hello there timmy")         # Write the message "Why, hello there!"
